...
def get_cached_loader(image_ids, labels, responses, batch_size, names=('inputs', 'targets'), shuffle=True, image_cache=None, repeat_condition=None):
    """
    ...
    dataset = CachedTensorDataset(image_ids, labels, names=names, image_cache=image_cache)
