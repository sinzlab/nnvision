...
class MultiplePointPooled2d(nn.ModuleDict):
    ...
    def regularizer(self, data_key):
        return (
            self[data_key].feature_l1(average=self.readout_reg_avg) * self.gamma_readout
        )


def stacked2d_core_point_readout(
    dataloaders,
    seed,
    hidden_channels=32,
