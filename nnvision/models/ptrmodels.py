...
from .readouts import MultipleFullGaussian2d, MultiReadout, MultipleSpatialXFeatureLinear, MultipleRemappedGaussian2d, MultipleSelfAttention2d
...
def custom_task_core_gauss_readout(dataloaders, seed,
                            input_channels=1, model_name='vgg19',  # begin of core args
                            layer_name='features.10', pretrained=True, bias = False,
                            final_batchnorm=True, final_nonlinearity=True,
                            momentum=0.1,fine_tune=False,
    ...
    core = TaskDrivenCore3(input_channels=core_input_channels,
                           model_name=model_name,
                           layer_name=layer_name,
                           pretrained=pretrained,
                           bias=bias,
...
def custom_task_core_selfattention_readout(dataloaders, seed,
                                   input_channels=1, model_name='vgg19',  # begin of core args
                                   layer_name='features.10', pretrained=True, bias = False,
                                   final_batchnorm=True, final_nonlinearity=True,
                                   momentum=0.1,fine_tune=False,
                                   readout_bias=True, gamma_features=3.0, gamma_query=1,
                                   elu_offset=-1, data_info=None,
                                   shifter = None, shifter_type = 'MLP', input_channels_shifter = 2,
                                   hidden_channels_shifter = 5,
                                   shift_layers = 3, gamma_shifter = 0, shifter_bias = True,
...
def task_core_remapped_gauss_readout(dataloaders, seed,
                            input_channels=1, model_name='vgg19',  # begin of core args
                            layer_name='features.10', pretrained=True, bias=False,
                            final_batchnorm=True, final_nonlinearity=True,
                            momentum=0.1, fine_tune=False,
                            init_mu_range=0.4, init_sigma_range=0.6,  # readout args,
                            readout_bias=True, gamma_readout=0.01, gauss_type='isotropic',
                            elu_offset=-1, data_info=None, remap_layers=2, remap_kernel=3, max_remap_amplitude=.2,  # output and data_info
                            ):
    """
    A Model class of a predefined core (using models from ptrnets). Can be initialized pretrained or random.
    Can also be set to be trainable or not, independent of initialization.
