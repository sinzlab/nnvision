...
from .readouts import MultiplePointPooled2d, MultipleFullGaussian2d, MultiReadout, MultipleSpatialXFeatureLinear, MultipleRemappedGaussian2d, MultipleGaussian2d, MultipleAttention2d, MultipleDense, MultipleSelfAttention2d, MultipleMultiHeadAttention2d, MultipleSharedMultiHeadAttention2d
...
try:
    ...
    print("datajoint connection not established, skipping model imports from nnfabrik tables")
...
def se_core_shared_multihead_attention(dataloaders, seed, hidden_channels=32, input_kern=13,  # core args
                                        hidden_kern=3, layers=3, gamma_input=15.5,
                                        skip=0, final_nonlinearity=True, momentum=0.9,
                                        pad_input=False, batch_norm=True, hidden_dilation=1,
                                        laplace_padding=None, input_regularizer='LaplaceL2norm',
    ...
    readout = MultipleSharedMultiHeadAttention2d(core,in_shape_dict=in_shapes_dict,
                                                n_neurons_dict=n_neurons_dict,
                                                bias=readout_bias,
                                                gamma_features=gamma_features,
                                                gamma_query=gamma_query,
