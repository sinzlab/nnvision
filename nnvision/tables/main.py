...
class MonkeyExperiment(dj.Computed):
    ...
    def make(self, key):
        ...
        for file in filenames:
            ...
            unit_ids = raw_data["unit_indices"] if "unit_indices" in raw_data else np.arange(raw_data["testing_responses"].shape[1])
...
# refactor: only create one dict. makes much more sense dude
# and add sessions measures.