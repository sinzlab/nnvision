    ...
    def make(self, key):
        ...
        for k, v in session_dict.items():
            ...
            for i, neuron_id in enumerate(session_dict[k]["unit_id"]):
                key["unit_id"] = int(neuron_id) if combined_neuron_counter is None else combined_neuron_counter
                key["unit_index"] = i if combined_neuron_counter is None else combined_neuron_counter
                ...
                combined_neuron_counter += 1 if combined_neuron_counter is not None else 0
